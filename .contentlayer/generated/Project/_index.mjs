...
import projects__costOfLivingMdx from './projects__cost-of-living.mdx.json' with { type: 'json' }
...
export const allProjects = [projects__brickSpiderMdx, projects__costOfLivingMdx, projects__expectoMdx, projects__jiwwMdx, projects__knutCounterMdx, projects__marketsweeperMdx, projects__melodestinyMdx, projects__sandwichDotCodesMdx, projects__smartthingspublicMdx, projects__soundOfWallMdx, projects__spearmintRhinoMdx, projects__splinchedMdx]
